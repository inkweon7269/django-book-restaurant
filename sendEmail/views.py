...
def sendEmail(request):
    ...
    for checked_res_id in checked_res_list:
        ...
        mail_html += "<h4>" + restaurant.restaurant_link + "<h4>"
        mail_html += "<p>" + restaurant.restaurant_content + "<p>"
        mail_html += "<p>" + restaurant.restaurant_keyword + "<p>"

    mail_html += "</body></html>"

    # Using SMTP
    server = smtplib.SMTP_SSL('smtp.gmail.com', 465)
    server.login("계정ID", "계정비번")

    msg = MIMEMultipart('alternative')
    msg['Subject'] = inputTitle
    msg['From'] = "inkweon7269@gmail.com"
